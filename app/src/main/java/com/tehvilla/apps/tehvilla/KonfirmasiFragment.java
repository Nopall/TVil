...
public class KonfirmasiFragment extends Fragment implements OnPermissionCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_konfirmasi, container, false);
        ButterKnife.bind(this,rootView);
        HomeActivity.txttoolbar.setText("KONFIRMASI PEMBAYARAN");
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        iBtnUpload = (ImageButton) rootView.findViewById(R.id.iBtnUpload);
...
//                boolean result=Utility.checkPermission(MainActivity.this);
    ...
    public void KlikSelesaiKonfirmasi(){
        ...
        if (filePath == null){
            Toast.makeText(getContext(), "Mohon lampirkan bukti transfer", Toast.LENGTH_SHORT).show();
        }

        if(orderId.getText().toString().equals("") == false && namaRekening.getText().toString().equals("")== false &&
                nominal.getText().toString().equals("") == false && tanggal.getText().toString().equals("") == false ){
            if(filePath != null) {
                File file = com.tehvilla.apps.tehvilla.helpers.FileUtils.getFile(getActivity(),filePath);
...
//                    Toast.makeText(getContext(),kodeSorting,Toast.LENGTH_LONG).show();
                        if (response.body().getResponse().toString().equals("[]") && response.body().getResult()==true) {
                            ...
                            Toast.makeText(getContext(), "Pembayaran Anda Sedang Kami Proses", Toast.LENGTH_LONG).show();
