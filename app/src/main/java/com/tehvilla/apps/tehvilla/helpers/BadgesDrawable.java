...
public class BadgesDrawable extends Drawable {
    ...
    public BadgesDrawable(Context context) {
        float mTextSize = context.getResources().getDimension(R.dimen._8ssp);
        ...
        mBadgePaint1.setColor(ContextCompat.getColor(context.getApplicationContext(), R.color.md_red_A400));
